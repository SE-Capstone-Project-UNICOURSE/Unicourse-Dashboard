...
import type { FiltersProps } from './components/CourseLecturerFilter';
import CourseFilter from './components/CourseLecturerFilter';
import CourseItem from './components/CourseLecturerItem';
import CourseSort from './components/CourseLecturerSort';
